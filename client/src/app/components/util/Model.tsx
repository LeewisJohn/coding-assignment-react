...
const Model = (props: Props) => {
  const { onClose, onSubmit, isLoading, children: ModelBody, className, isForm } = props;
      ...
      >
        ...
        {isForm && (
          <div className='mt-8 flex justify-end gap-x-3'>
            ...
            <button onClick={onSubmit} disabled={isLoading} className={`btn ${isLoading ? 'disabled:opacity-50' : ''}`}>
